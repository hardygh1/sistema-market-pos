  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #dc3545 !important;">
    ...
    <a href="index3.html" class="brand-link">
      <img src="vistas/assets/dist/img/LogoTienda.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Tienda Marta la NR1</span>
    </a>
